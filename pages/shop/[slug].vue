...
<script setup>
  ...
  let { title, image, description } = toRefs(product)
  const products = [
    {
        slug: "syringe",
        title: "Syringe",
        description: "Syringes for general outpatients",
        image: "/images/200x200.png"
    },
    {
        slug: "glove",
        title: "Glove",
        description: "Gloves for outpatients",
        image: "/images/200x200.png"
    },
  ]
  const found = products.find(post => post.slug === route.params.slug)
  title = found.title 
  image = found.image
